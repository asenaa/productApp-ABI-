import 'dart:convert';
import 'package:abiteam/detay.dart';
...
class _MyHomePageState extends State<MyHomePage> {
                        ...
                        Padding(
                            ...
                            child: Theme(
                              ...
                              child: TextFormField(
                                ...
                                //textin içine yazılan yazıyı okumak için scanf()
  ...
  void createUrun(
    String urunAdi, String urunAciklamasi, int urunAdedi, double urunFiyati) {
    var body = jsonEncode ({
      "urunAdi": urunAdi,
  ...
  try {
    http.put(uri,
    body: body,
    headers: {"context-type": "application/json","accept":"application/json"}).then((response){
